...
initial_impact = impact(pos_pumps)
...
class MyProblem(ElementwiseProblem):
    ...
    def _evaluate(self, x, out, *args, **kwargs):
        ...
        f1 = impact(pos_pumps,x)-initial_impact  # Negative impact calculation with new x location
...
pos_pumps = np.concatenate((pos_pumps,res.X), axis = 0)
